  ...
  describe('Bookmarks', () => {
    ...
    describe('Create bookmark', () => {
      const createBookmarkDto: CreateBookmarkDto = {
        ...
        link: 'https://github.com/vladwulf/nestjs-api-tutorial/tree/main',
        description: 'This project github repository',
      };
    ...
    describe('Edit bookmark by id', () => {
      const editBookmarkDto: EditBookmarkDto = {
        ...
        link: 'https://github.com/vladwulf/nestjs-api-tutorial/blob/main/src/bookmark/dto/edit-bookmark.dto.ts',
